...
<head>
    ...
    <title>A server error has prevented the requested resource from being displayed</title>
	...
	<script type="text/javascript"><!-- //
		!window.jQuery && document.write(unescape('%3Cscript src="https://static.qgov.net.au/assets/v2/script/jquery-1.4.4-min.js"%3E%3C/script%3E'));
	// --></script>
...
<!-- noindex -->
	...
	<div id="header-wrapper"><div id="header"><div id="header-bg"></div><div class="box-sizing"><div class="max-width">
		...
		<div id="qg-logo"><a href="https://www.qld.gov.au/">
			<!--[if gte IE 7]><!--><img src="https://static.qgov.net.au/assets/v2/images/skin/qg-logo.png" width="266" height="45" alt="Queensland Government home" /><!--<![endif]-->
			<!--[if lte IE 6]><img src="https://static.qgov.net.au/assets/v2/images/skin/qg-logo-ie6.png" width="266" height="45" alt="Queensland Government home" /><![endif]-->
			<img src="https://static.qgov.net.au/assets/v2/images/skin/qg-logo-print.png" width="240" height="42" class="print-version" alt="" />
		</a></div>
			...
			<li class="last-child" id="header-search">
				<form action="http://pan.search.qld.gov.au/search/search.cgi" id="search-form">
					<div>
						...
						<input id="search-button" type="image" src="https://static.qgov.net.au/assets/v2/images/skin/button-search.png" value="Search" />
		...
		<div id="nav-site"><ul>
			...
			<!--<li class="nav-non-residents">
				<a href="https://www.qld.gov.au/non-residents/">For non-residents</a>
			</li>-->
		</ul></div>
...
<li><a href="https://www.qld.gov.au/services/">Services</a></li>
      </ol>
    </div>
...
<div class="tf-status"><div class="tf-fail inner">
        <h1>No resource exists for the requested address</h1>

        <p>You can:</p>
        <ul>
            <li class="recommended">Check the address has been entered correctly
                and try again</li>
            <li>Use the <a href="#search-query">site search</a> to
                find similar resources</li>

            <li>Return to the <a href="http://www.qld.gov.au/">home page</a> and look for
                links to other related information</li>
        </ul>

        <h2>Further assistance</h2>
        <p>Please <a href="https://www.qld.gov.au/contact-us">contact us</a> if you require further assistance with
        your request.</p>
    </div></div>
...
<div id="footer">
		...
		<div class="max-width"><div class="box-sizing">
			...
			<div class="section" id="for-qldrs">
				...
				<ul>
                    ...
                    <li><a href="https://www.qld.gov.au/employment/">Employment and jobs</a></li>
	...
	<div class="max-width"><div class="box-sizing">
		...
		<!-- endnoindex -->
		<p class="legal">© The State of Queensland 1995–2014</p>
